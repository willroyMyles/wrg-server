...
import {BsHouse, BsList, BsHouseDoor, BsPerson} from "react-icons/bs"
	...
	const links = [
		{
			...
			// 	size={iconSize}
			// />,
			event: eventStrings.homeSelected,
		},
		{name: "categories", icon: BsList, event: eventStrings.categoriesSelected},
		{name: "profile", icon: BsPerson, event: eventStrings.settingsSelected},
	]
	return (
		<CustomMenu objects={links} />
		// <Row
		// 	align="middle"
